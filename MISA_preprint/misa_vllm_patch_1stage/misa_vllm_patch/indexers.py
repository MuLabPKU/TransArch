...
from .misa_ops import misa_page_mqa_logits, misa_mqa_logits, misa_mqa_softmax_logits
...
def misa_sparse_attn_indexer(
    ...
    if has_prefill:
        ...
        for chunk in prefill_metadata.chunks:
            ...
            topk_indices = torch.topk(logits, k=min(topk_tokens, logits.shape[-1]), dim=-1, largest=True).indices  # [M, topk]
